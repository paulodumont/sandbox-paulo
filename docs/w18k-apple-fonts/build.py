...
<div class="rec"><div class="kicker">Decisão</div>
<p><b>SF Pro com números tabulares</b> em todo o sistema: <b>SF Pro Display Semibold</b> nos títulos e valores grandes, <b>SF Pro Text</b> no corpo, com <b>números tabulares</b> ativados em KPIs, tabelas e formulários. <b>SF Mono</b> apenas em SKU, pedidos e certificados.</p>
<p style="margin:0">Regra vigente a partir de 7 de setembro de 2026 para toda tela nova e toda tela existente que for alterada. A Opção B (New York) fica só como referência para site e materiais de cliente.</p></div>
